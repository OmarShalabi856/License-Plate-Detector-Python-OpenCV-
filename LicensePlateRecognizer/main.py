...
my_Canvas.create_text( 855, 90, text="OPTIONS", fill="#fff", font=('Helvetica 15 bold') )
my_Canvas.pack()
my_Canvas.create_rectangle( 810, 380, 910, 110, outline="#fff" )
...
btn_Exit.place( x=820, y=320 )
btn_Copy.place( x=820, y=220 )
btn_Recognize.place( x=820, y=130 )
